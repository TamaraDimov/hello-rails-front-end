...
Link from the back end project : https://github.com/TamaraDimov/hello-rails-back-end
...
Feel free to check the [issues page](https://github.com/TamaraDimov/hello-rails-front-end/issues).
